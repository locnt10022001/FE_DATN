import { Carousel, Row, Col, Typography, Button, Card, message, Input, Select, Pagination } from "antd";
  ...
  return (
    <div className="container mx-auto mt-6">
      ...
      <Carousel autoplay className="mb-6 rounded-lg overflow-hidden shadow-lg">
        <img src="https://bansinonbaohiem.com/wp-content/uploads/2018/07/banner-ban-si-non-bao-hiem-hcm.jpg" alt="Banner 1" className="carousel-img" />
        <img src="https://img.freepik.com/free-psd/rider-concept-banner-template_23-2148634991.jpg?t=st=1733675458~exp=1733679058~hmac=7cb8baaebccb217a3e8b6e609892baa6d4d47f813ecd1b2d4636407c9920135f&w=2000" alt="Banner 2" className="carousel-img" />
        <img src="https://img.freepik.com/free-vector/gradient-racing-template-design_23-2150152645.jpg?t=st=1733675512~exp=1733679112~hmac=c84655a064b69fabab34d2219ff4fc246f738b8f440cd79fbdebe2c21c798ce8&w=2000" alt="Banner 3" className="carousel-img" />
        <img src="https://img.freepik.com/premium-psd/psd-black-friday-super-sale-web-banner-template_428858-1461.jpg?w=2000" alt="Banner 4" className="carousel-img" />
      </Carousel>
